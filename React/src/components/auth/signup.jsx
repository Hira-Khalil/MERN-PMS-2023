...
function Signup(updateState) {
    ...
    return (
        <div class="bg-gray-50 h-full w-screen">
            <div class="w-5/6 mx-auto max-w-screen-1 p-4 md:p-6 2xl:p-10">
                        ...
                        <div class="hidden w-full xl:block xl:w-1/2">
                            <div class="text-center mt-10">
                                <a class="inline-block" href="index.html">
                                    <img class="dark:hidden inline rounded-lg" src="../../download.png" width="30px" alt="Logo" />
                                    <span class="text-3xl text-black font-bold px-4 ">ProjecTech</span>                </a>

                                <p class="font-medium 2xl:px-20 mt-4 mb-5 padd">
                                    Sign up to our ProjecTech platform to manage all your projects efficiently.
                                </p>

                                <span class=" inline-block pb-15">
                                    <img class="pb-7" src="../../pic.svg" alt="illustration" />
                                </span>
                            </div>
                        </div>
                        <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                            <div class="w-full p-8 sm:p-12.5 xl:p-17.5">
                                <p className="mb-2">Let's get back to your account!</p>

                                <h2 class="mb-5 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                    Sign up to ProjecTech
                                </h2>
                                ...
                                <div class="mb-4">
                                    <label class="mb-2.5 block font-medium text-black dark:text-white">Last Name</label>
                                    <div class="relative">
                                        <input onChange={(e) => {
                                            setLastName(e.target.value);
                                        }} type="text" placeholder="Enter your Last Name" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" fdprocessedid="3jpumg" />
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        }} type="email" placeholder="Enter your email" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" fdprocessedid="3jpumg" />
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        }} type="password" placeholder="6+ Characters, 1 Capital letter" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" fdprocessedid="5ofv7b" />
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        }} class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" name="role" id="role">
                                            <option value="instructor">Instructor</option>
                                            <option value="trainee">trainee</option>

                                        </select>                                            <span class="absolute right-4 top-4">
                                            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g opacity="0.5">
                                                    <path d="M16.1547 6.80626V5.91251C16.1547 3.16251 14.0922 0.825009 11.4797 0.618759C10.0359 0.481259 8.59219 0.996884 7.52656 1.95938C6.46094 2.92188 5.84219 4.29688 5.84219 5.70626V6.80626C3.84844 7.18438 2.33594 8.93751 2.33594 11.0688V17.2906C2.33594 19.5594 4.19219 21.3813 6.42656 21.3813H15.5016C17.7703 21.3813 19.6266 19.525 19.6266 17.2563V11C19.6609 8.93751 18.1484 7.21876 16.1547 6.80626ZM8.55781 3.09376C9.31406 2.40626 10.3109 2.06251 11.3422 2.16563C13.1641 2.33751 14.6078 3.98751 14.6078 5.91251V6.70313H7.38906V5.67188C7.38906 4.70938 7.80156 3.78126 8.55781 3.09376ZM18.1141 17.2906C18.1141 18.7 16.9453 19.8688 15.5359 19.8688H6.46094C5.05156 19.8688 3.91719 18.7344 3.91719 17.325V11.0688C3.91719 9.52189 5.15469 8.28438 6.70156 8.28438H15.2953C16.8422 8.28438 18.1141 9.52188 18.1141 11V17.2906Z" fill=""></path>
                                                    <path d="M10.9977 11.8594C10.5852 11.8594 10.207 12.2031 10.207 12.65V16.2594C10.207 16.6719 10.5508 17.05 10.9977 17.05C11.4102 17.05 11.7883 16.7063 11.7883 16.2594V12.6156C11.7883 12.2031 11.4102 11.8594 10.9977 11.8594Z" fill=""></path>
                                ...
                                <div class="mb-5">
                                    <input onClick={() => {
                                        void SIGNUP();
                                    }} type="submit" value="Sign up" class="w-full bg-blue-700 cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90" fdprocessedid="w3gbmc" />
                                </div>

                                <button class="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 font-medium hover:border-gray-200 hover:bg-opacity-70 focus:outline-none" fdprocessedid="46rl4">
                                    <span>
                                ...
                                <div class="mt-6 text-center">
                                    <p class="font-medium">
                                        ...
                                        }} class="text-blue-600 ps-1">Sign In</a>                                        </p>
                                </div>
                            </div>
                        </div>
                    </div>

...
function Login(updateState) {
  ...
  return (
    <div class="w-screen bg-gray-50 h-screen">
            ...
            <div class="hidden w-full xl:block xl:w-1/2">
              <div class="text-center mt-10">
                ...
                <p class="font-medium 2xl:px-20 mt-4 mb-5 padd">
                  Sign in to our ProjecTech platform to manage all your projects efficiently.
                </p>
              ...
              <div class="w-full p-8 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                  <div class="mb-4">
                    ...
                    <div class="relative">
                      <input type="email" placeholder="Enter your email" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" fdprocessedid="3jpumg"
                        onChange={(e) => {
                  ...
                  <div class="mb-6">
                    ...
                    <div class="relative">
                      ...
                      }} placeholder="6+ Characters, 1 Capital letter" class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" fdprocessedid="5ofv7b" />
                  ...
                  <div class="mb-5">
                    <input onClick={() => {
                      void login();
                    }} disabled={!(email && password)} type="submit" value="Sign In" class="w-full bg-blue-700 cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90" fdprocessedid="w3gbmc" />
                  </div>
                  ...
                  <div class="mt-6 text-center">
                    <p class="font-medium">
                      ...
                      }} class="text-blue-600 ps-1">Sign Up</a>
                    </p>
                  </div>
                </form>
              </div>

...
const Nav = () => {
    ...
    return (
        <div className='bg-white shadow-md   rounded-full flex fixed top-8 right-11 '>
      ...
      text-gray-800'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ' : 'top-[-490px]'}`}>
                    ...
                    <li className='p-3  cursor-pointer'>                        <img src="https://source.unsplash.com/100x100/?portrait" alt="" className="w-8 h-8 rounded-full" />
                    </li>
                </ul>
            </div>
        </div>
